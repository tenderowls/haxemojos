 ...
 */
package org.haxe.maven.components.lifecycle;
...
public abstract class AbstractHaxeLifecycleMapping
{
    ...
    public Map<String, Lifecycle> getLifecycles()
    {
        ...
        phases.put( "test-compile", "org.haxe.maven:haxe-maven-plugin:testCompile");
        phases.put( "test", "org.haxe.maven:haxe-maven-plugin:testRun" );
